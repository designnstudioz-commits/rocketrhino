import svgPaths from "./svg-wh1n2u85ts";
...
function Frame31() {
  return (
    <div className="absolute bg-gradient-to-r blur-[12px] from-[rgba(152,40,117,0.3)] h-[1025px] left-[620px] opacity-50 right-0 rounded-[18px] to-[rgba(227,47,118,0.3)] top-0" data-name="Frame">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[18px]" />
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-[#bf00ff] content-stretch flex gap-[8px] isolate items-center justify-center left-0 py-[16px] rounded-[12px] top-[694px] w-[446px]" data-name="button">
    ...
    <div className="bg-[rgba(5,6,10,0.5)] relative rounded-[12px] shrink-0 w-full z-[1]" data-name="textarea">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col isolate items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.5px] w-full z-[1]">Tell us about your current challenges...</p>
        </div>
      </div>
...
function Input() {
  return (
    <div className="bg-[rgba(5,6,10,0.5)] relative rounded-[12px] shrink-0 w-full z-[1]" data-name="input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col isolate items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.5px] w-full z-[1]">Jane Doe</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(44,48,144,0.3)] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
...
function Input1() {
  return (
    <div className="bg-[rgba(5,6,10,0.5)] relative rounded-[12px] shrink-0 w-full z-[1]" data-name="input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col isolate items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.5px] w-full z-[1]">jane@company.com</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(44,48,144,0.3)] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
...
function Input2() {
  return (
    <div className="bg-[rgba(5,6,10,0.5)] relative rounded-[12px] shrink-0 w-full z-[1]" data-name="input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col isolate items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.5px] w-full z-[1]">Acme Corp</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(44,48,144,0.3)] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex isolate items-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-ellipsis text-white tracking-[-0.5px] w-[110px] whitespace-nowrap z-[1]">
            <p className="leading-[20px] overflow-hidden text-ellipsis">Select an option...</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame32() {
  return (
    <div className="absolute bg-[#121319] content-stretch drop-shadow-[0px_0px_7.5px_#050047] flex flex-col gap-[32px] isolate items-start left-[624px] p-[40px] rounded-[16px] top-[4px] w-[528px]" data-name="Frame">
